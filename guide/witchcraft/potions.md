...
1. **Learn a recipe.** Potion recipes arrive through main story quests and magical tasks for coven members — the early quest *Something's Brewing* is exactly what it sounds like. You can't brew what nobody's taught you.
2. **Gather ingredients.** Recipes draw on all three of your daytime trades: crops you've [farmed](../farming/crops.md), plants and oddments you've [foraged, and ores you've mined](../farming/mining-and-foraging.md).
...
The full recipe book is long — the names below are ones this journal has confirmed; you'll unlock plenty more, including powders and distillations, as your studies deepen.
...
A note on the two families you'll lean on hardest:

- **The Miracle Grow line** is the farm's best friend. Speeding a slow crop toward harvest is lovely; speeding one to beat an incoming [season change](spells-and-rituals.md) — before out-of-season crops vanish — is *survival*. And don't sleep on the crafting-station trick: a splash on a slow station hurries artisan goods too ([Artisan Goods](../crafting/artisan-goods.md)).
- **Revitalizing Potions** quietly rewrite your daily [energy budget](../getting-started/energy-time-seasons.md). A witch with a bottled second wind mines deeper, fishes longer, and still makes it to the circle by moonrise.

> ⚠️ spoilers — some brews exist purely to move the story. Quest potions (banishing-adjacent brews, ritual components like the Spirit Flame, remedies for particular townsfolk's particular problems) unlock exactly when the plot needs them. If a quest is waiting on a potion, the quest itself supplies the recipe — check your to-do list before panic-foraging.

---

## Stocking the Witch's Pantry

Brewing rewards the player who hoards a little of everything:

| Source | Keep on hand | Why |
| --- | --- | --- |
| Farming | A few of each crop, each season | Recipes and coven tasks love asking for what just went out of season |
| Foraging | Wild plants, mushrooms, flowers | The classic potion base; free for the walking |
