...
Here we press the showiest blooms in the whole garden: the spells. Where [potions](potions.md) are quiet bottled helpers, incantations are magic performed out loud — and some of them turn the wheel of the year itself.
...
| Write it down | The desk in your workroom | Magic + special ingredients |
| Cast it | Read aloud (some at specific places) | The scroll itself — consumed on use |

You cannot buy your way into new magic. Spells unlock by **progressing the main story** and by **completing magical tasks for coven members** — see [The Craft: An Introduction](introduction.md) for how the coven takes you under its wing. Keep your pantry and ore chest stocked; ingredient requests arrive without warning ([Mining & Foraging](../farming/mining-and-foraging.md) is your friend).

<span class="handwritten">write two of anything you'd cry about wasting 🌙</span>

---

## The Season-Change Ritual
...
## Verified Spells & Incantations

There are roughly **thirty incantations** to learn across the story. Below are ones this journal can vouch for by name; treat effects marked briefly as summaries, and discover the rest in the wild.
...
> ⚠️ spoilers — several late spells (the banishment, the fae fealty, the shapeshifting) are welded to major story beats involving the coven's history and the island's hidden folk. The quest lines introduce them far better than a table can.

The time-bending spells deserve a special toast: between freezing, speeding, and reversing the day, an established witch simply *owns* the clock in ways a Chapter 1 farmer wouldn't dare dream.

---

## Broom Flying

Yes, you get the broom. Broom flight arrives via the story (a broom in working order is part of the fun — a certain quest line involves getting yours fixed up) and once you have it, crossing the island stops costing you your whole morning. Swooping over your own farm at dusk remains one of the game's purest joys; the [island map](../island/map.md) looks much friendlier from above.

## Ritual Etiquette for the New Witch
