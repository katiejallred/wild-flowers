...
South of town, the island meets the sea. The beach is prime territory for [fishing](../farming/fishing.md) and beachcombing for forageables and shells (the [Interactive Fishing & Foraging Map](fishing-map.html) marks every cast-worthy shore and berry patch), and the docks are where boats (and the occasional new arrival) come in. Kai Hoapili, the island's friendly merchant, keeps his wares near here — see [Shops & Services](shops.md).
