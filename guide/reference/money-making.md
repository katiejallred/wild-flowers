...
For the full per-season ledger — seed costs, growth times, and every crop's coins/day — see the [Crop Guide](../farming/crops.md). To run the numbers for *your* plan — your season, your length of stay, your number of beds — try the interactive [Crop Profit Calculator](crop-profit-calculator.html).
