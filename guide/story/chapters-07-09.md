...
> ⚠️ Spoilers ahead — major ones. Winter of Year 1: wraiths, accusations, and the rogue witch revealed.

Winter is when Fairhaven's two smouldering troubles finally catch the same wind. The quests in this stretch braid them together: the island's supernatural disturbances erupt into the open, and the town's suspicion of witchcraft boils over with them.
...
- **Keep your cauldron stocked.** The crisis quests call for potions and incantations on short notice — [Potions](../witchcraft/potions.md) and [Spells & Rituals](../witchcraft/spells-and-rituals.md) are your almanacs.
- **Don't neglect the farm.** Winter [crops are lean](../farming/crops.md), but preserved goods and the [mines](../farming/mining-and-foraging.md) keep coin coming while the plot thickens.
- **Talk to everyone between quests.** The town's fear, the League's doubt, and the coven's exhaustion all live in the between-scenes dialogue. It's some of the best writing in the game.

<span class="handwritten">Pressed here: a blackened leaf from the old tree. It still feels cold. 🌙</span>
