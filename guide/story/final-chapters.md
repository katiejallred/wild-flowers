...
The main storyline ends with **Locket Up**, which begins the moment **Witch Way Did She Go** concludes. A wraith has possessed Vanessa, and the coven must banish it before it consumes her — and the town with her.

The set-piece is wonderful: Shelby holds a **Freeze Time** incantation over the town square while you hurry through the stilled streets gathering what the banishment spell demands. Verified pickings include:

| Item | Where |
| --- | --- |
| Otto's Wedding Ring | Speak to Otto on the bench by the eastern staircase |
| Key to the Fairhaven School | Speak to Sebastián by the western staircase |
| Vanessa's Gloves | On the teacher's desk inside the school |
| Further components | Other villagers frozen around the square — talk to everyone; you can't leave while time stands still |

Cast the banishment, and the wraith is driven out. Completing the quest rewards an **Increase Magic** spell for your grimoire.
...
<span class="handwritten">Pressed here: one wylde flower, from the first spring. It has kept its colour. 🌙</span>
